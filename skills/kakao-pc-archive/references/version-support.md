...
- 검증 장비 A Intel Mac x86_64 + macOS 13.7.8 + KakaoTalk for Mac 26.1.4 build 1163 + `kakaocli 0.4.1`: 현재 기본 검증 기준.
- 재현 장비 B + KakaoTalk for Mac 26.4.1 build 1181 + `kakaocli 0.4.1`: 동일 direct DB read workflow 재현 기록 있음.
...
Verified baselines: an Intel Mac x86_64 device with macOS 13.7.8 and KakaoTalk for Mac 26.1.4 build 1163, plus a reproduced direct DB read workflow on another Mac with KakaoTalk for Mac 26.4.1 build 1181. Both use `kakaocli 0.4.1`, checked on 2026-06-03.
