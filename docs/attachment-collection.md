...
확인일: 2026-06-03
호스트 OS: macOS 13.7.8
KakaoTalk for Mac: 26.1.4 build 1163 on Intel Mac; read-only DB behavior also reproduced on 26.4.1 build 1181 on Apple Silicon Mac
