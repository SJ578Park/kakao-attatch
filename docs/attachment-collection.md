...
확인일: 2026-06-03
호스트 OS: macOS 13.7.8
KakaoTalk for Mac: 26.1.4 build 1163 on Intel Mac
이전 첨부 probe: 2026-05-21
결과: 새 이미지/스프레드시트 URL은 HTTP 200, 오래된 URL은 HTTP 410 사례 확인
Apple Silicon probe: arm64, Apple M4, macOS 26.4.1, KakaoTalk for Mac 26.4.1 build 1181에서 attachment JSON parse와 URL 샘플 접근 통과. 최근 URL 샘플 25개 중 HTTP 206 19건, HTTP 200 4건, HTTP 303 1건, HTTP 403 1건.
```

HTTP 410은 “이미 만료됨”으로 취급합니다. fatal error가 아니라 정상적인 만료 결과로 기록합니다.
HTTP 403/303도 URL 접근 결과로 기록하고, 같은 run에서 2xx/206이 확인되면 fresh URL 접근은 가능한 것으로 봅니다.
...
The primary verified baseline is Intel Mac x86_64 with KakaoTalk for Mac 26.1.4 build 1163 as of 2026-06-03. Attachment behavior was probed locally on 2026-05-21: fresh image/spreadsheet URLs returned HTTP 200, while older URLs returned HTTP 410. Apple Silicon arm64 / Apple M4 with KakaoTalk for Mac 26.4.1 build 1181 was rechecked on 2026-06-03: sampled attachment URL access returned HTTP 206 for 19 URLs, HTTP 200 for 4 URLs, HTTP 303 for 1 URL, and HTTP 403 for 1 URL.
