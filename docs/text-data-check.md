...
Use `kakaocli` to read the KakaoTalk for Mac local SQLCipher database in read-only mode. The verified baseline is macOS 13.7.8 and KakaoTalk for Mac 26.1.4 as of 2026-06-03.
